...
class Securimage {
  ...
  function image($formid) {
      $this->image_width = $_SESSION['smartformer']['sec_code'][$formid]['width'];
      $this->image_height = $_SESSION['smartformer']['sec_code'][$formid]['height'];
  ...
  function output()
  {
      ...
      ImagePNG($this->im);//,$GLOBALS['sf_absolute_path'].'/components/com_smartformer/captcha/securimage/tmp.png');
/*    header("Expires: Sun, 1 Jan 2000 12:00:00 GMT");
  ...
  function saveData()
  {
    //$_SESSION['smartformer']['sec_code'] = strtolower($this->code);
